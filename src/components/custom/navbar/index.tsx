        ...
        <>
            <div className="flex w-full justify-between items-center min-h-14 opacity-0 pointer-events-none md:opacity-100 md:pointer-events-auto px-6 max-w-7xl mx-auto">
                <div className="flex items-center gap-2 min-w-32">
                    ...
                    <h1 className="text-lg font-black">CVA</h1>
                </div>
                <div className="min-w-32 flex items-center gap-2 justify-end">
                    <Link href={"https://github.com/vaxad/create-vaxad-app/"} className="flex w-fit items-center gap-1 hover:border-b border-foreground cursor-pointer">
                        Repo
                        <ArrowTopRightIcon />
                    </Link>
                    <ModeToggle />
